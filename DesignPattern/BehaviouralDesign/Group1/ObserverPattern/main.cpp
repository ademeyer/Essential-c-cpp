...
public:
  ...
  void subscribe(Subscriber *subscriber) override { this->subscribers.push_back(subscriber); }
...
public:
  ...
  {
    std::cout << userName << " reveived a new message from " << publisherName << ": " << message << std::endl;
  }
